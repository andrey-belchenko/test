 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/C:/Repos/mygithub/test/soap-client-try/src/main/resources/wsdl/TestService.wsdl")
    ...
    extends jakarta.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/Repos/mygithub/test/soap-client-try/src/main/resources/wsdl/TestService.wsdl");
